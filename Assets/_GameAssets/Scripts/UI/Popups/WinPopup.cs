...
public class WinPopup : MonoBehaviour
{
    ...
    private void OnMainMenuButtonClicked()
    {
        ...
        {
            UnityEngine.SceneManagement.SceneManager.LoadScene(Consts.SceneNames.MENU_SCENE);
        }
    }
    ...
    private void OnOneMoreButtonClicked()
    {
        ...
        {
            UnityEngine.SceneManagement.SceneManager.LoadScene(Consts.SceneNames.GAME_SCENE);
        }
    }
